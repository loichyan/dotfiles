...
return function()
  ...
  if NOT_VSCODE then
    ...
    Util.concat(keymaps, {
      ...
      { "<A-y>", "@smart_splits.resize_left", mode = nixt },
      { "<A-u>", "@smart_splits.resize_down", mode = nixt },
      { "<A-i>", "@smart_splits.resize_up", mode = nixt },
      { "<A-o>", "@smart_splits.resize_right", mode = nixt },
      { "<Leader>-", "@window.split" },
